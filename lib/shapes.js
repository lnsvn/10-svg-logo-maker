...
// Circle class (inserts inputs from the inquirer prompts)
...
// Square class (inserts inputs from the inquirer prompts)
...
// Triangle class (inserts inputs from the inquirer prompts)
...
// function to insert the shape and text information from the classes above into a template to generate svg code
